...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='EoK26zREvHsaadi3ERkb.Fg2xAK8+c6My92znQ5+akW.enDyWVFjK3wryJcNs+3r/55+ks5NdPj09G1mcVOtbSM=')
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='EoOjWWliXDx572yKytp8.tSL6Ni+BpiVGFpzQ9Gu22a.skct4nFlftb0I+EZQdpQGvqROiUcLpxeX45nTvo3NFQ=')
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
#kk.login(qr=True)
kk.login(token='EoTAsnwnw6jpKgps5iV6.xuC8K6+gzJsmen91eTrSPG.hqPduphMBKgLMCrYvuTzFcMSgKtEl1RyzZv33FAysOA=') 
kk.loginResult() 
print "Kk-Login Success\n"

kc = LINETCR.LINE()
#kc.login(qr=True)
kc.login(token='EoE7WPhayhCvGOrtfES4.CKP6GP5GmFyfYuKxouLRXa.VJbheiGKdScymwnjnxvUEn3StgAwEgONffOfnG6lfPA=')
kc.loginResult()
print "Kc-Login Success\n"

kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='EojeD0tztvLuHWTlMINb.F3dwbSK4u10C9ILUzTcpQW.g0JMsiy2uSJeIYj4Ot4k/Cca08q7Yot0BASb28sugJI=')
kr.loginResult()
print "Kr-Login Success\n"

km = LINETCR.LINE()
#km.login(qr=True)
km.login(token='Eo8mmqMuNQI9nzPkrcpf.TZjEI917pMDTTp1BY9K5+W.cYdG2Tucf/t021bNcwL27jjwDMfIXP584viOUGvSKd0=') 
km.loginResult()
...
def download_page(url):
    ...
    if cur_version >= version:     
        ...
        try:
            headers = {}
            headers['User-Agent'] = "Line/7.14.0 iPAD5,1 10.2.0"
    ...
    try:
	 ...
	 if wait["Ghost"] == True:
		...
		cl.sendText(msg.to,"Itu Majikan Kami (^_^)")
                ...
                msg.contentType = 13
                admin1 = "u3be861eaf85ef27656cf9159916229ca"
                admin2 = "u4fd239a77c16d1ea7853cd801f6c379d"
                admin3 = "u4a361586c55ac4ef218a0a9b78b2f1b3"
                msg.contentMetadata = {'mid': WIB}
		...
		cl.sendText(msg.to,"Itu Yang Buat Grup Ini")
            ...
            elif msg.text in ["Key creator","Help sky1","Help creator"]:
                cl.sendText(msg.to,creatorMessage)

            elif msg.text in ["Key group","Help sky2","Help group"]:
                cl.sendText(msg.to,groupMessage)

            elif msg.text in ["Key","help","Help"]:
                cl.sendText(msg.to,helpMessage)

            elif msg.text in ["Key self","Help sky3","Help self"]:
                cl.sendText(msg.to,selfMessage)

            elif msg.text in ["Key bot","Help sky4","Help bot"]:
                cl.sendText(msg.to,botMessage)

            elif msg.text in ["Key set","Help sky5","Help set"]:
                cl.sendText(msg.to,setMessage)

            elif msg.text in ["Key media","Help sky6","Help media"]:
                cl.sendText(msg.to,mediaMessage)
                
            elif msg.text in ["Key admin","Help sky7","Help admin"]:
		...
		cl.sendText(msg.to,"Pasukan Absen!!")
                ki.sendText(msg.to,"Sky1 Hadiir  \(ˆ▿ˆ)/")
                kk.sendText(msg.to,"Sky2 Hadiir  \(ˆ▿ˆ)/")
                kc.sendText(msg.to,"Sky3 Hadiir  \(ˆ▿ˆ)/")
                kr.sendText(msg.to,"Hadiir Semua Sky \(ˆ▿ˆ)/")
